-- Recreate work_paper_note_signatures table (if rollback needed)
...
-- Drop the work_paper_signatures table
DROP TRIGGER IF EXISTS update_work_paper_signatures_updated_at ON work_paper_signatures;
DROP INDEX IF EXISTS idx_work_paper_signatures_work_paper_id;
DROP INDEX IF EXISTS idx_work_paper_signatures_user_id;
DROP INDEX IF EXISTS idx_work_paper_signatures_status;
DROP INDEX IF EXISTS idx_work_paper_signatures_unique_user_paper;
DROP TABLE IF EXISTS work_paper_signatures;