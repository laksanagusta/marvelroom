...
var (
	...
	ErrDuplicateWorkPaper                   = errors.New("duplicate work paper for organization, year, semester, and name")
	ErrWorkPaperTopicNotFound               = errors.New("work paper topic not found")
	ErrWorkPaperTopicNameRequired           = errors.New("work paper topic name is required")
	ErrDuplicateWorkPaperTopicName          = errors.New("work paper topic name already exists")
	...
	ErrWorkPaperItemDeskInstructionRequired = errors.New("work paper item desk instruction is required")
	...
	ErrMasterLakipItemStatementRequired = ErrWorkPaperItemDeskInstructionRequired
